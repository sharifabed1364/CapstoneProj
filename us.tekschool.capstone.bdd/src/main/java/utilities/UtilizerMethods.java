...
public class UtilizerMethods extends Base {
	...
	public static void takeScreenShot() {
		...
		String location = System.getProperty("http://tek-school.com/retail/index.php?route=checkout/cart") + "\\output\\screenshots\\";
